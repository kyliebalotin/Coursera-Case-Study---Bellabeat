...
Then I looked at the survey's responses regarding how participants are using their smart phones and wearables (ex: fitness tracking, sleep monitoring, etc) and reasons why the participants might not own a wearable. I have performed these calculations for the whole survey sample population and the subset of the sample population that identify as female. 
```{r calculations}
...
Finally, I plot the different calculations in order to show my findings visually. 
```{r plots}
...
grid.arrange(demographic_age, demographic_age_f, 
             demographic_edu, demographic_edu_f, 
             demographic_emp, demographic_emp_f, 
             demographic_eth, demographic_eth_f,
             nrow=4, ncol=2,
             top="Demographic Information About Survey Participants", bottom = "Plots in left column represent the whole survey participant population; plots in the right column represent survey participants who identify as female")
